...
- **CI runs on `main`, never on a pull request.** Before handoff, run the
  ...
  broad. Main CI runs the uncached full inventory after integration; a red main
  revision is fixed forward.
